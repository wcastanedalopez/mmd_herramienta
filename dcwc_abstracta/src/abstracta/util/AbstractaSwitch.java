...
public class AbstractaSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AbstractaPackage.MODEL_FACTORY_ABSTRACTA_WC: {
				ModelFactoryAbstractaWc modelFactoryAbstractaWc = (ModelFactoryAbstractaWc)theEObject;
				T result = caseModelFactoryAbstractaWc(modelFactoryAbstractaWc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AbstractaPackage.NAMED_ELEMNT_WC: {
				NamedElemntWc namedElemntWc = (NamedElemntWc)theEObject;
				T result = caseNamedElemntWc(namedElemntWc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AbstractaPackage.PROJECT_WC: {
				ProjectWc projectWc = (ProjectWc)theEObject;
				T result = caseProjectWc(projectWc);
				if (result == null) result = caseNamedElemntWc(projectWc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AbstractaPackage.PACKAGE_WC: {
				PackageWc packageWc = (PackageWc)theEObject;
				T result = casePackageWc(packageWc);
				if (result == null) result = caseNamedElemntWc(packageWc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AbstractaPackage.PACKAGE_ELEMENT_WC: {
				PackageElementWc packageElementWc = (PackageElementWc)theEObject;
				T result = casePackageElementWc(packageElementWc);
				if (result == null) result = caseNamedElemntWc(packageElementWc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AbstractaPackage.CLASSIFIER_WC: {
				ClassifierWc classifierWc = (ClassifierWc)theEObject;
				T result = caseClassifierWc(classifierWc);
				if (result == null) result = caseNamedElemntWc(classifierWc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AbstractaPackage.DATA_TYPE_FACTORY_WC: {
				DataTypeFactoryWc dataTypeFactoryWc = (DataTypeFactoryWc)theEObject;
				T result = caseDataTypeFactoryWc(dataTypeFactoryWc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AbstractaPackage.TYPE_WC: {
				TypeWc typeWc = (TypeWc)theEObject;
				T result = caseTypeWc(typeWc);
				if (result == null) result = caseClassifierWc(typeWc);
				if (result == null) result = caseNamedElemntWc(typeWc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AbstractaPackage.CLASS_WC: {
				ClassWc classWc = (ClassWc)theEObject;
				T result = caseClassWc(classWc);
				if (result == null) result = caseClassifierWc(classWc);
				if (result == null) result = caseNamedElemntWc(classWc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AbstractaPackage.RELATION_WC: {
				RelationWc relationWc = (RelationWc)theEObject;
				T result = caseRelationWc(relationWc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AbstractaPackage.COMPOSITION: {
			...
			case AbstractaPackage.GENERALIZATION: {
			...
			case AbstractaPackage.AGGREGATION: {
			...
			case AbstractaPackage.ASSOCIATION: {
			...
			case AbstractaPackage.RELATION_BINARY: {
			...
			case AbstractaPackage.FEATURE_WC: {
				FeatureWc featureWc = (FeatureWc)theEObject;
				T result = caseFeatureWc(featureWc);
				if (result == null) result = caseNamedElemntWc(featureWc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AbstractaPackage.ATTRIBUTE_WC: {
				...
				if (result == null) result = caseNamedElemntWc(attributeWc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AbstractaPackage.METHOD_WC: {
				MethodWc methodWc = (MethodWc)theEObject;
				T result = caseMethodWc(methodWc);
				if (result == null) result = caseFeatureWc(methodWc);
				if (result == null) result = caseNamedElemntWc(methodWc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Model Factory Abstracta Wc</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Model Factory Abstracta Wc</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseModelFactoryAbstractaWc(ModelFactoryAbstractaWc object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Named Elemnt Wc</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Named Elemnt Wc</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNamedElemntWc(NamedElemntWc object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Package Element Wc</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Package Element Wc</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePackageElementWc(PackageElementWc object) {
		return null;
	}
