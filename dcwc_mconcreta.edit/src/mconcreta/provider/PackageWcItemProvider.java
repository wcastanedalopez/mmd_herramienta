...
/**
 * This is the item provider adapter for a {@link mconcreta.PackageWc} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PackageWcItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PackageWc_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PackageWc_name_feature", "_UI_PackageWc_type"),
				 MconcretaPackage.Literals.PACKAGE_WC__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MconcretaPackage.Literals.PACKAGE_WC__PATH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MconcretaPackage.Literals.PACKAGE_WC__CHILDREN_PACKAGES_WC);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MconcretaPackage.Literals.PACKAGE_WC__CHILDREN_PACKAGES_WC,
