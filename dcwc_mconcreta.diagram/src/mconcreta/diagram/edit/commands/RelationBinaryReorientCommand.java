 ...
 * @generated
 */
public class RelationBinaryReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public RelationBinaryReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof RelationBinary) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return MconcretaBaseItemSemanticEditPolicy.getLinkConstraints().canExistRelationBinary_4005(container,
	...
	* @generated
	*/
	protected RelationBinary getLink() {
		return (RelationBinary) getElementToEdit();
	}
