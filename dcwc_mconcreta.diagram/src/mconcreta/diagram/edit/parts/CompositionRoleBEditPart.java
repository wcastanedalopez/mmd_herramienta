 ...
 * @generated
 */
public class CompositionRoleBEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				MconcretaVisualIDRegistry.getType(mconcreta.diagram.edit.parts.CompositionRoleBEditPart.VISUAL_ID),
				new Point(3, 12));
	}
	...
	* @generated
	*/
	public CompositionRoleBEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new CompositionroleBLabelFigure();
	}

	/**
	 * @generated
	 */
	public class CompositionroleBLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public CompositionroleBLabelFigure() {
			this.setText("roleB");
		}
