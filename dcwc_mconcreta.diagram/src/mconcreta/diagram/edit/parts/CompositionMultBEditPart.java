 ...
 * @generated
 */
public class CompositionMultBEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				MconcretaVisualIDRegistry.getType(mconcreta.diagram.edit.parts.CompositionMultBEditPart.VISUAL_ID),
				new Point(20, -12));
	}
	...
	* @generated
	*/
	public CompositionMultBEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new CompositionmultBLabelFigure();
	}

	/**
	 * @generated
	 */
	public class CompositionmultBLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public CompositionmultBLabelFigure() {
			this.setText("multB");
		}
