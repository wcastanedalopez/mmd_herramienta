 ...
 * @generated
 */
public class CompositionRoleAEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				MconcretaVisualIDRegistry.getType(mconcreta.diagram.edit.parts.CompositionRoleAEditPart.VISUAL_ID),
				new Point(0, 12));
	}
	...
	* @generated
	*/
	public CompositionRoleAEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new CompositionroleALabelFigure();
	}

	/**
	 * @generated
	 */
	public class CompositionroleALabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public CompositionroleALabelFigure() {
			this.setText("roleA");
		}
