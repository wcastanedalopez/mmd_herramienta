 ...
 * @generated
 */
public class AggregationRoleAEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				MconcretaVisualIDRegistry.getType(mconcreta.diagram.edit.parts.AggregationRoleAEditPart.VISUAL_ID),
				new Point(0, 12));
	}
	...
	* @generated
	*/
	public AggregationRoleAEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AggregationroleALabelFigure();
	}

	/**
	 * @generated
	 */
	public class AggregationroleALabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AggregationroleALabelFigure() {
			this.setText("roleA");
		}
