 ...
 * @generated
 */
public class AssociationMultAEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				MconcretaVisualIDRegistry.getType(mconcreta.diagram.edit.parts.AssociationMultAEditPart.VISUAL_ID),
				new Point(-20, -12));
	}
	...
	* @generated
	*/
	public AssociationMultAEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MconcretaParserProvider.getParser(MconcretaElementTypes.Association_4004, getParserElement(),
					MconcretaVisualIDRegistry.getType(mconcreta.diagram.edit.parts.AssociationMultAEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AssociationmultALabelFigure();
	}

	/**
	 * @generated
	 */
	public class AssociationmultALabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AssociationmultALabelFigure() {
			this.setText("multA");
		}
