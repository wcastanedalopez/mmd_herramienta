 ...
 * @generated
 */
public class RelationBinaryRoleAEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				MconcretaVisualIDRegistry.getType(mconcreta.diagram.edit.parts.RelationBinaryRoleAEditPart.VISUAL_ID),
				new Point(0, 12));
	}
	...
	* @generated
	*/
	public RelationBinaryRoleAEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = MconcretaParserProvider.getParser(MconcretaElementTypes.RelationBinary_4005, getParserElement(),
					MconcretaVisualIDRegistry
							.getType(mconcreta.diagram.edit.parts.RelationBinaryRoleAEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new RelationBinaryroleALabelFigure();
	}

	/**
	 * @generated
	 */
	public class RelationBinaryroleALabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RelationBinaryroleALabelFigure() {
			this.setText("roleA");
		}
