 ...
 * @generated
 */
public class CompositionMultAEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				MconcretaVisualIDRegistry.getType(mconcreta.diagram.edit.parts.CompositionMultAEditPart.VISUAL_ID),
				new Point(-20, -12));
	}
	...
	* @generated
	*/
	public CompositionMultAEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MconcretaParserProvider.getParser(MconcretaElementTypes.Composition_4001, getParserElement(),
					MconcretaVisualIDRegistry.getType(mconcreta.diagram.edit.parts.CompositionMultAEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new CompositionmultALabelFigure();
	}

	/**
	 * @generated
	 */
	public class CompositionmultALabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public CompositionmultALabelFigure() {
			this.setText("multA");
		}
