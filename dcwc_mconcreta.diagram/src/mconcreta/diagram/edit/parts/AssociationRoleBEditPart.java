 ...
 * @generated
 */
public class AssociationRoleBEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				MconcretaVisualIDRegistry.getType(mconcreta.diagram.edit.parts.AssociationRoleBEditPart.VISUAL_ID),
				new Point(3, 12));
	}
	...
	* @generated
	*/
	public AssociationRoleBEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AssociationroleBLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AssociationroleBLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AssociationroleBLabelFigure() {
			this.setText("roleB");
		}
