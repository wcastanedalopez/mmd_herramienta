 ...
 * @generated
 */
public class AttributeWcNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AttributeWcNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected Image getLabelIcon() {
		...
		return MconcretaElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MconcretaParserProvider.getParser(MconcretaElementTypes.AttributeWc_3001, getParserElement(),
					MconcretaVisualIDRegistry.getType(mconcreta.diagram.edit.parts.AttributeWcNameEditPart.VISUAL_ID));
		}
		return parser;
	}
