 ...
 * @generated
 */
public class AggregationRoleBEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				MconcretaVisualIDRegistry.getType(mconcreta.diagram.edit.parts.AggregationRoleBEditPart.VISUAL_ID),
				new Point(3, 12));
	}
	...
	* @generated
	*/
	public AggregationRoleBEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AggregationroleBLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AggregationroleBLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AggregationroleBLabelFigure() {
			this.setText("roleB");
		}
