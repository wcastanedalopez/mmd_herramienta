 ...
 * @generated
 */
public class AssociationRoleAEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				MconcretaVisualIDRegistry.getType(mconcreta.diagram.edit.parts.AssociationRoleAEditPart.VISUAL_ID),
				new Point(0, 12));
	}
	...
	* @generated
	*/
	public AssociationRoleAEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AssociationroleALabelFigure();
	}

	/**
	 * @generated
	 */
	public class AssociationroleALabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AssociationroleALabelFigure() {
			this.setText("roleA");
		}
