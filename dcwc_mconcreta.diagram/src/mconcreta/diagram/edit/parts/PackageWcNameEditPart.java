 ...
 * @generated
 */
public class PackageWcNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PackageWcNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MconcretaParserProvider.getParser(MconcretaElementTypes.PackageWc_2002, getParserElement(),
					MconcretaVisualIDRegistry.getType(mconcreta.diagram.edit.parts.PackageWcNameEditPart.VISUAL_ID));
		}
		return parser;
	}
