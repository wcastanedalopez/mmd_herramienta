 ...
 * @generated
 */
public class ClassWcNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ClassWcNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MconcretaParserProvider.getParser(MconcretaElementTypes.ClassWc_2001, getParserElement(),
					MconcretaVisualIDRegistry.getType(mconcreta.diagram.edit.parts.ClassWcNameEditPart.VISUAL_ID));
		}
		return parser;
	}
