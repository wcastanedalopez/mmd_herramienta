...
import mconcreta.diagram.edit.policies.MconcretaTextSelectionEditPolicy;
 ...
 * @generated
 */
public class RelationBinaryMultBEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				MconcretaVisualIDRegistry.getType(mconcreta.diagram.edit.parts.RelationBinaryMultBEditPart.VISUAL_ID),
				new Point(20, -12));
	}
	...
	* @generated
	*/
	public RelationBinaryMultBEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new MconcretaTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MconcretaParserProvider.getParser(MconcretaElementTypes.RelationBinary_4005, getParserElement(),
					MconcretaVisualIDRegistry
							.getType(mconcreta.diagram.edit.parts.RelationBinaryMultBEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, MconcretaEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new RelationBinarymultBLabelFigure();
	}

	/**
	 * @generated
	 */
	public class RelationBinarymultBLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RelationBinarymultBLabelFigure() {
			this.setText("multB");
		}
