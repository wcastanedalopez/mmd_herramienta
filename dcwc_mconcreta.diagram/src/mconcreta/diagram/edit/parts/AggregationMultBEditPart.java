 ...
 * @generated
 */
public class AggregationMultBEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				MconcretaVisualIDRegistry.getType(mconcreta.diagram.edit.parts.AggregationMultBEditPart.VISUAL_ID),
				new Point(20, -12));
	}
	...
	* @generated
	*/
	public AggregationMultBEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MconcretaParserProvider.getParser(MconcretaElementTypes.Aggregation_4003, getParserElement(),
					MconcretaVisualIDRegistry.getType(mconcreta.diagram.edit.parts.AggregationMultBEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AggregationmultBLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AggregationmultBLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AggregationmultBLabelFigure() {
			this.setText("multB");
		}
