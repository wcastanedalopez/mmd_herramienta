 ...
 * @generated
 */
public class RelationBinaryRoleBEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				MconcretaVisualIDRegistry.getType(mconcreta.diagram.edit.parts.RelationBinaryRoleBEditPart.VISUAL_ID),
				new Point(3, 12));
	}
	...
	* @generated
	*/
	public RelationBinaryRoleBEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = MconcretaParserProvider.getParser(MconcretaElementTypes.RelationBinary_4005, getParserElement(),
					MconcretaVisualIDRegistry
							.getType(mconcreta.diagram.edit.parts.RelationBinaryRoleBEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new RelationBinaryroleBLabelFigure();
	}

	/**
	 * @generated
	 */
	public class RelationBinaryroleBLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RelationBinaryroleBLabelFigure() {
			this.setText("roleB");
		}
