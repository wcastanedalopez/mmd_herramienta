 ...
 * @generated
 */
public class MethodWcNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MethodWcNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MconcretaParserProvider.getParser(MconcretaElementTypes.MethodWc_3002, getParserElement(),
					MconcretaVisualIDRegistry.getType(mconcreta.diagram.edit.parts.MethodWcNameEditPart.VISUAL_ID));
		}
		return parser;
	}
