 ...
 * @generated
 */
public class RelationBinaryMultAEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				MconcretaVisualIDRegistry.getType(mconcreta.diagram.edit.parts.RelationBinaryMultAEditPart.VISUAL_ID),
				new Point(-20, -12));
	}
	...
	* @generated
	*/
	public RelationBinaryMultAEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = MconcretaParserProvider.getParser(MconcretaElementTypes.RelationBinary_4005, getParserElement(),
					MconcretaVisualIDRegistry
							.getType(mconcreta.diagram.edit.parts.RelationBinaryMultAEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new RelationBinarymultALabelFigure();
	}

	/**
	 * @generated
	 */
	public class RelationBinarymultALabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RelationBinarymultALabelFigure() {
			this.setText("multA");
		}
