 ...
 * @generated
 */
public class AggregationMultAEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				MconcretaVisualIDRegistry.getType(mconcreta.diagram.edit.parts.AggregationMultAEditPart.VISUAL_ID),
				new Point(-20, -12));
	}
	...
	* @generated
	*/
	public AggregationMultAEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AggregationmultALabelFigure();
	}

	/**
	 * @generated
	 */
	public class AggregationmultALabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AggregationmultALabelFigure() {
			this.setText("multA");
		}
