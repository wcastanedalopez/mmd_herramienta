 ...
 * @generated
 */
public class AssociationMultBEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				MconcretaVisualIDRegistry.getType(mconcreta.diagram.edit.parts.AssociationMultBEditPart.VISUAL_ID),
				new Point(20, -12));
	}
	...
	* @generated
	*/
	public AssociationMultBEditPart(View view) {
		super(view);
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AssociationmultBLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AssociationmultBLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AssociationmultBLabelFigure() {
			this.setText("multB");
		}
