 ...
 * @generated
 */
public class ClassWcClassWcAttributesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return MconcretaPackage.eINSTANCE.getClassWc_Attributes();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<MconcretaNodeDescriptor> childDescriptors = MconcretaDiagramUpdater
				.getClassWcClassWcAttributesCompartment_7001SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return AttributeWcEditPart.VISUAL_ID == MconcretaVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<MconcretaNodeDescriptor> childDescriptors = MconcretaDiagramUpdater
				.getClassWcClassWcAttributesCompartment_7001SemanticChildren((View) getHost().getModel());
