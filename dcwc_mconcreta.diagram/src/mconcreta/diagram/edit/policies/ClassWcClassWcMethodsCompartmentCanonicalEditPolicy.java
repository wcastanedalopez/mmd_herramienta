 ...
 * @generated
 */
public class ClassWcClassWcMethodsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return MconcretaPackage.eINSTANCE.getClassWc_Methods();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<MconcretaNodeDescriptor> childDescriptors = MconcretaDiagramUpdater
				.getClassWcClassWcMethodsCompartment_7002SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return MethodWcEditPart.VISUAL_ID == MconcretaVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<MconcretaNodeDescriptor> childDescriptors = MconcretaDiagramUpdater
				.getClassWcClassWcMethodsCompartment_7002SemanticChildren((View) getHost().getModel());
