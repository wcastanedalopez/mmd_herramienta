 ...
 * </p>
 * <ul>
 *   <li>{@link mconcreta.impl.RelationWcImpl#getType <em>Type</em>}</li>
 *   <li>{@link mconcreta.impl.RelationWcImpl#getMultA <em>Mult A</em>}</li>
 *   <li>{@link mconcreta.impl.RelationWcImpl#getMultB <em>Mult B</em>}</li>
 *   <li>{@link mconcreta.impl.RelationWcImpl#getRoleA <em>Role A</em>}</li>
 *   <li>{@link mconcreta.impl.RelationWcImpl#getRoleB <em>Role B</em>}</li>
 *   <li>{@link mconcreta.impl.RelationWcImpl#getSource <em>Source</em>}</li>
 *   <li>{@link mconcreta.impl.RelationWcImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class RelationWcImpl extends EObjectImpl implements RelationWc {
	...
	protected EClass eStaticClass() {
		return MconcretaPackage.Literals.RELATION_WC;
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MconcretaPackage.RELATION_WC__TYPE, oldType, type));
	}
	...
	public void setMultA(String newMultA) {
		...
		multA = newMultA;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MconcretaPackage.RELATION_WC__MULT_A, oldMultA, multA));
	}
	...
	public void setMultB(String newMultB) {
		...
		multB = newMultB;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MconcretaPackage.RELATION_WC__MULT_B, oldMultB, multB));
	}
	...
	public void setRoleA(String newRoleA) {
		...
		roleA = newRoleA;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MconcretaPackage.RELATION_WC__ROLE_A, oldRoleA, roleA));
	}
	...
	public void setRoleB(String newRoleB) {
		...
		roleB = newRoleB;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MconcretaPackage.RELATION_WC__ROLE_B, oldRoleB, roleB));
	}
	...
	public ClassWc getSource() {
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MconcretaPackage.RELATION_WC__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(ClassWc newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MconcretaPackage.RELATION_WC__SOURCE, oldSource, source));
	}
	...
	public ClassWc getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MconcretaPackage.RELATION_WC__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(ClassWc newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MconcretaPackage.RELATION_WC__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MconcretaPackage.RELATION_WC__TYPE:
				return getType();
			case MconcretaPackage.RELATION_WC__MULT_A:
				return getMultA();
			case MconcretaPackage.RELATION_WC__MULT_B:
				return getMultB();
			case MconcretaPackage.RELATION_WC__ROLE_A:
				return getRoleA();
			case MconcretaPackage.RELATION_WC__ROLE_B:
				return getRoleB();
			case MconcretaPackage.RELATION_WC__SOURCE:
				if (resolve) return getSource();
				return basicGetSource();
			case MconcretaPackage.RELATION_WC__TARGET:
